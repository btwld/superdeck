...
class SlideMapper extends ClassMapperBase<Slide> {
  ...
  static const Field<Slide, SlideOptions> _f$options = Field(
    'options',
    _$options,
    opt: true,
  );
  static List<SectionBlock> _$sections(Slide v) => v.sections;
  static const Field<Slide, List<SectionBlock>> _f$sections = Field(
    'sections',
    _$sections,
    opt: true,
    def: const [],
  );
  static List<String> _$notes(Slide v) => v.notes;
  static const Field<Slide, List<String>> _f$notes = Field(
    'notes',
    _$notes,
    opt: true,
    def: const [],
...
extension SlideValueCopy<$R, $Out> on ObjectCopyWith<$R, Slide, $Out> {
  SlideCopyWith<$R, Slide, $Out> get $asSlide =>
      $base.as((v, t, t2) => _SlideCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _SlideCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Slide, $Out>
  ...
  SlideCopyWith<$R2, Slide, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _SlideCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
class SlideOptionsMapper extends ClassMapperBase<SlideOptions> {
  ...
  static const Field<SlideOptions, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  ...
  static const Field<SlideOptions, String> _f$template = Field(
    'template',
    _$template,
    opt: true,
  );
  static Map<String, Object?> _$args(SlideOptions v) => v.args;
  static const Field<SlideOptions, Map<String, Object?>> _f$args = Field(
    'args',
    _$args,
    opt: true,
    def: const {},
...
mixin SlideOptionsMappable {
  ...
  @override
  String toString() {
    return SlideOptionsMapper.ensureInitialized().stringifyValue(
      this as SlideOptions,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return SlideOptionsMapper.ensureInitialized().equalsValue(
      this as SlideOptions,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SlideOptionsMapper.ensureInitialized().hashValue(
      this as SlideOptions,
    );
  }
}
...
extension SlideOptionsValueCopy<$R, $Out>
  ...
  SlideOptionsCopyWith<$R, SlideOptions, $Out> get $asSlideOptions =>
      $base.as((v, t, t2) => _SlideOptionsCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _SlideOptionsCopyWithImpl<$R, $Out>
  ...
  SlideOptionsCopyWith<$R2, SlideOptions, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _SlideOptionsCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
