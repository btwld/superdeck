...
class DeckMapper extends ClassMapperBase<Deck> {
  ...
  static DeckWorkspace _$configuration(Deck v) => v.configuration;
  static const Field<Deck, DeckWorkspace> _f$configuration = Field(
    'configuration',
    _$configuration,
  );
...
abstract class DeckCopyWith<$R, $In extends Deck, $Out>
  ...
  DeckWorkspaceCopyWith<$R, DeckWorkspace, DeckWorkspace> get configuration;
  $R call({List<Slide>? slides, DeckWorkspace? configuration});
...
class _DeckCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Deck, $Out>
  ...
  @override
  $R call({List<Slide>? slides, DeckWorkspace? configuration}) => $apply(
    FieldCopyWithData({
