...
import 'package:superdeck_genui/src/ai/services/prompt_builder.dart';
  ...
  group('buildPromptFromWizardContext', () {
    ...
    group('input sanitization', () {
      test('truncates topic exceeding max length', () {
        ...
        // Should contain truncated topic (500 chars) with ellipsis
      ...
      test('preserves newlines and tabs in input', () {
        final prompt = buildPromptFromWizardContext(
      ...
      test('handles null values gracefully', () {
        ...
        // Should not contain "Topic:" line when null
