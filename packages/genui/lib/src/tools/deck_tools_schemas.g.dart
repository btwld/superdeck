...
extension type ReadSlideRequestType(Map<String, Object?> _data)
  ...
  ReadSlideRequestType copyWith({int? index}) {
    return ReadSlideRequestType.parse({'index': index ?? this.index});
  }
}
...
extension type CreateSlideRequestType(Map<String, Object?> _data)
  ...
  CreateSlideRequestType copyWith({
    Map<String, dynamic>? schema,
    int? atIndex,
  }) {
    return CreateSlideRequestType.parse({
      'schema': schema ?? this.schema,
      'atIndex': atIndex ?? this.atIndex,
    });
  }
}
...
extension type UpdateSlideRequestType(Map<String, Object?> _data)
  ...
  UpdateSlideRequestType copyWith({int? index, Map<String, dynamic>? schema}) {
    return UpdateSlideRequestType.parse({
...
extension type DeleteSlideRequestType(Map<String, Object?> _data)
  ...
  DeleteSlideRequestType copyWith({int? index}) {
    return DeleteSlideRequestType.parse({'index': index ?? this.index});
  }
}
...
extension type MoveSlideRequestType(Map<String, Object?> _data)
  ...
  MoveSlideRequestType copyWith({int? fromIndex, int? toIndex}) {
    return MoveSlideRequestType.parse({
...
extension type UpdateStyleRequestType(Map<String, Object?> _data)
  ...
  UpdateStyleRequestType copyWith({Map<String, dynamic>? style}) {
    return UpdateStyleRequestType.parse({'style': style ?? this.style});
  }
}
...
extension type SlideSummaryType(Map<String, Object?> _data)
  ...
  SlideSummaryType copyWith({int? index, String? key, String? title}) {
...
extension type DeckSnapshotType(Map<String, Object?> _data)
  ...
  DeckSnapshotType copyWith({
    int? totalSlides,
    List<SlideSummaryType>? slides,
...
extension type ReadSlidePayloadType(Map<String, Object?> _data)
  ...
  ReadSlidePayloadType copyWith({
    int? index,
    String? key,
    Map<String, dynamic>? schema,
    String? thumbnail,
  }) {
    return ReadSlidePayloadType.parse({
      'index': index ?? this.index,
      'key': key ?? this.key,
      'schema': schema ?? this.schema,
...
extension type SlideMutationResultType(Map<String, Object?> _data)
  ...
  SlideMutationResultType copyWith({
    Map<String, dynamic>? slide,
    Map<String, dynamic>? deck,
  }) {
...
extension type StyleUpdateResultType(Map<String, Object?> _data)
  ...
  StyleUpdateResultType copyWith({
    Map<String, dynamic>? style,
    Map<String, dynamic>? deck,
  }) {
