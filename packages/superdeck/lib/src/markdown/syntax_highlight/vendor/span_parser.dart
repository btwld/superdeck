// Vendored unchanged from syntax_highlight 0.5.0 (pub.dev), file
// `lib/src/span_parser.dart`, at https://github.com/serverpod/syntax_highlight
// commit 7ac296c6 (2025-08-19), which took it from Flutter DevTools. See the
// licence text reproduced in `LICENSE` beside this file, and the notes in
// `highlighter.dart`.
