...
class SlideFixtures {
  ...
  static Slide twoColumnWeighted({
    ...
    return _slide('fixture-two-column-weighted', [
      SectionBlock([
  ...
  static Slide threeColumn() {
    return _slide('fixture-three-column', [
      SectionBlock([
        ContentBlock('# One'),
        ContentBlock('# Two'),
        ContentBlock('# Three'),
  ...
  static Slide threeColumnWeighted({
    ...
    return _slide('fixture-three-column-weighted', [
      SectionBlock([
  ...
  static Slide twoSectionWeighted({int topFlex = 1, int bottomFlex = 2}) {
    return _slide('fixture-two-section-weighted', [
  ...
  static Slide threeSectionLayout({
    ...
    return _slide('fixture-three-section', [
  ...
  static Slide multiSectionMultiColumn() {
    return _slide('fixture-multi-section-multi-column', [
      SectionBlock([
    ...
    return _slide(
      ...
      rows
          .map(
            (row) => SectionBlock(
              row
                  .map((align) => ContentBlock(align.name, align: align))
                  .toList(),
            ),
          )
          .toList(),
  ...
  static Slide scrollableBlock({int lineCount = 50}) {
    ...
    return _slide('fixture-scrollable-block', [
      SectionBlock([ContentBlock(content, scrollable: true)]),
    ]);
  }
  ...
  static Slide nonScrollableBlock({int lineCount = 50}) {
    ...
    return _slide('fixture-non-scrollable-block', [
      SectionBlock([ContentBlock(content, scrollable: false)]),
    ]);
  }
...
'''),
  ...
  static Slide mixedMarkdown() {
    return _slide('fixture-mixed-markdown', [
      SectionBlock([
        ContentBlock('''
# Title
