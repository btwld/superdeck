...
import 'package:playground/features/ai/generation/core/engine/services/deck_generator_pipeline_helpers.dart';
import 'package:playground/features/ai/generation/core/engine/services/generated_slide_validator.dart';
import 'package:playground/features/ai/generation/core/engine/services/generation_element_catalog.dart';
...
void main() {
  test('normalizes generation args into canonical flattened arguments', () {
    ...
    final errors = validateGeneratedSlideIssues(
  ...
  test('rejects slide separators but allows them inside fenced code', () {
    final catalog = GenerationElementCatalog.builtIn();
    final unsafeErrors = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content': 'Before\n\n---\n\nAfter',
    ...
    final fencedErrors = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content': '```text\n---\n```',
  ...
  test('requires unsupported visible numeric claims to be qualified', () {
    ...
    final rejected = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final allowed = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content':
    ...
    final structuralCounts = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final inventedZero = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final enumeratedSteps = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content':
    ...
    final inventedDuration = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
  ...
  test('rejects an unsupported visible commercial commitment', () {
    ...
    final waitlistErrors = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final complianceErrors = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
  ...
  test('reports a supplied metric reused with a different meaning', () {
    ...
    final changedMeaning = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final inventedCausalMeaning = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final preservedMeaning = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final broadenedFraction = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content':
  ...
  test('rejects open-ended metric inflation unless explicitly supplied', () {
    final exactOnly = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
    ...
    final explicitlyOpenEnded = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content': '## 38+ design partners',
  ...
  test('requires unsupported capability claims to remain hypothetical', () {
    final unqualified = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content':
    ...
    final qualified = validateGeneratedSlideIssues(
      expectedKey: 'test-slide',
      rawSlide: _slideWithBlock({
        'type': 'block',
        'content':
