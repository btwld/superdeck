...
import '../ai/core/utils/color_utils.dart';
...
class _ColorControlState extends State<ColorControl> {
  ...
  void didUpdateWidget(ColorControl oldWidget) {
    ...
    // Pull external color changes (swatch tap, AI style, reset) into the field,
  ...
  Widget build(BuildContext context) {
    return ColumnBox(
      ...
      children: [
        if (widget.label != null) _ControlLabel(widget.label!),
        HeroTextField(
          fullWidth: true,
