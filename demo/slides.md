...
# Hello Friend {.hero-title}

---
title: Paragraph to heading — Before
---
...
A small idea can become a big story. {.paragraph-heading}

---
title: Paragraph to heading — After
---
...
# Make room for ideas {.heading-sizes}

---
title: Heading sizes — After
---
...
Good transitions preserve **every word**. This paragraph moves from a wide canvas into a narrower column, keeping its meaning and its *emphasis* intact. {.paragraph-reflow}

---
title: Paragraph reflow — After
---
...
A narrower column tells **a new story**. The old paragraph is erased, then this replacement types into its final layout with *emphasis* preserved. {.paragraph-reflow}

---
title: Image resize — Before
---
...
![Concepta](assets/concepta-icon.png) {.image-resize}

---
title: Image resize — After
---
...
---
title: Image replacement — Before
---
...
![Concepta](assets/concepta-icon.png) {.image-replace}

---
title: Image replacement — After
---
...
![SuperDeck](assets/transition-superdeck.png) {.image-replace}

---
title: Code changes — Before
---
