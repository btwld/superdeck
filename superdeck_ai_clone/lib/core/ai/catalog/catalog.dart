...
CatalogItem _withErrorHandling(CatalogItem item) {
  return CatalogItem(
    name: item.name,
    ...
    widgetBuilder: (context) {
      try {
        ...
        debugLog.error(item.name, 'Failed to build: $e', stack);
...
final chatCatalog = Catalog([
  _withErrorHandling(askUserRadio),
  _withErrorHandling(askUserCheckbox),
  _withErrorHandling(askUserSlider),
  _withErrorHandling(askUserText),
  _withErrorHandling(askUserStyle),
  _withErrorHandling(askUserImageStyle),
