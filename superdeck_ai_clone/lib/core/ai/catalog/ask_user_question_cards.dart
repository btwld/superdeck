          ...
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                Icon(
                  Icons.refresh,
                  color: FortalTokens.accent11.resolve(context),
                  size: 16,
                ),
                Text(
                  'Retry',
                  style: FortalTokens.text2
                      .mix()
                      .resolve(context)
                      .copyWith(color: FortalTokens.accent11.resolve(context)),
                ),
              ],
            ),
          ),
  ...
  Widget _buildPlaceholder(BuildContext context) {
    return Box(
      ...
      child: Icon(
        ...
        color: FortalTokens.gray7.resolve(context),
        size: 40,
      ),
    );
  }
