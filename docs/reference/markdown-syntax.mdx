...
| `@block` | Render markdown content | `flex`, `align`, `padding`, `scrollable` |
| `@widget` | Embed custom Flutter widgets | `name`, `flex`, `align`, `padding`, `scrollable` + custom args |
...
zero. `padding` is reserved and is not passed to custom widget args.
