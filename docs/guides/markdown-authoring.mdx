...
- `style` – Named style variant to apply (defined in `DeckPresentation.styles`)
...
Register widgets in `DeckPresentation.widgets`, then use them with the shorthand syntax:
