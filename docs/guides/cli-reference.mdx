...
Initialize SuperDeck in a Flutter project. Creates a sample `slides.md` file, updates `pubspec.yaml` with asset configuration, and configures a custom `web/index.html` for web.
