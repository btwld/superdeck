...
Create a SuperDeck starter app or refresh managed SuperDeck files in an existing app. Existing-app refreshes update SuperDeck-owned files and safe web/pubspec patches without replacing app code or platform scaffolds.
...
**Solution:** Ensure `slides.md` exists in project root. If this app was created with SuperDeck, run `superdeck create .` to refresh managed SuperDeck files.
