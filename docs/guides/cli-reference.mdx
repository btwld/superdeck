---
title: CLI reference
description: Complete reference for SuperDeck CLI setup and publishing commands
---

# CLI reference

The SuperDeck CLI provides project setup and publishing commands. Local slide
build/watch is owned by the runtime through `DeckSource.local(...)`.
